...
<div class="container mt-3">
    ...
    <a href="/tutorial/create" class="btn btn-success mb-3">+ Tambah Tutorial</a>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    <a href="<?= base_url('/presentation/' . $t['url_presentation']) ?>" target="_blank" class="btn btn-outline-dark btn-sm">
                        Tampilkan Presentasi
                    </a>
                </td>
                <td class="text-center">
                    <a href="<?= base_url('/finished/' . $t['url_finished']) ?>" target="_blank" class="btn btn-outline-dark btn-sm">
                        Tampilkan Finished
                    </a>
                </td>
